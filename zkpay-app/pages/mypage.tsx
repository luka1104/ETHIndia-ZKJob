...
import { BsFillCloudUploadFill, BsPatchCheckFill, BsPatchQuestion } from 'react-icons/bs'
        ...
        <Box>
          <Flex alignItems={"center"}>
            ...
            <Icon
              ...
              onClick={() => { user && !user.isVerified && router.push(`${process.env.NEXT_PUBLIC_WORLD_ID_URI}${user.address}`)}}
            />
          </Flex>
        </Box>
        <Box>
